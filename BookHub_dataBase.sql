create database bookhubbd;
drop database  bookhubbd;
use bookhubbd;
...
create table if not exists genres (
    ...
    foreign key (category_id) references genre(category_id) on delete set null
);
...
create table if not exists books (
    ...
    foreign key (author_id) references authors(authors_id) on delete cascade
);
...
create table if not exists order_items (
    ...
    foreign key ( book_id) references tovar( book_id) on delete no action on update cascade
);
